...
labResultSchema.virtual('displayValue').get(function() {
  if (this.parameterInfo?.dataType === 'numeric' && typeof this.value === 'number') {
...
labResultSchema.methods.interpretResult = function(parameterData, patientGender, patientAge) {
